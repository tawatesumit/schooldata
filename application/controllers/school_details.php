...
<div class="wrapper">
  <?php echo $this->load('layout/head'); ?>
...
//     /*print_r($role_id); die;*/
//     if ($role_id == 1) {
//        echo $this->include('layout/superadminsidebar');
//       }
//       else if ($role_id == 2) {
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <div class="form-group">
                        <!-- <label class="col-form-label" for="inputError">Organization<span style="color:red">&nbsp;*</span></label> -->
                        <select class="form-control select2" id="organization_id" name="organization_id" onchange="reload_table()" style="width: 100%;">
                          <option value="">Select Organization</option>
                          <?php
                            //   $set_org_value = array();
                            //   organization_master($set_org_value);
                          ?>
                        </select>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-3">
                      <a href="<?php echo base_url(); ?>admin/add" class="btn btn-sm btn-success" style="float:right;">Add New User</a>
                    </div>
                  </div>
              </div>
              <!-- /.card-header -->
...
<script>
  ...
  // });
    ...
    var table = $('#example1').DataTable({
          ...
          scrollCollapse: true,
          ajax: {
            url: site_url + "/admin/admin_ajax", // json datasource
            type: "post",
            data: function ( d ) {
