...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <form action="<?= base_url('school/save'); ?>" method="post">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" value="<?php echo set_value('name'); ?>" placeholder="Enter First Name..." required>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="col-form-label" for="inputError">Location</label>
                    <input type="text" name="location" id="location" class="form-control" value="<?php echo set_value('location'); ?>" placeholder="Enter Last Name..." required>
                  </div>
                </div>
              </div>
              <!-- <div class="row">
                ...
                <div class="card-footer text-center">
                  <button type="submit" class="btn btn-info">Save School Details</button>
