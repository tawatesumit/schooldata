...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <form action="<?= base_url('sliderinfo/save'); ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="col-form-label" for="inputError">Slider Image<span style="color:red">&nbsp;*</span></label>
                    <input type="file" name="slider_image" id="slider_image" class="form-control ">
                    <?php if ($validation->getError('slider_image')): ?>
                        <div class="invalid-feedback">
                            <?= $validation->getError('slider_image') ?>
                        </div>                                
                    <?php endif; ?>
                  </div>
                </div>
                <div class="col-sm-6">
                  <div class="form-group">
                    <label class="col-form-label" for="inputError">Slider Title</label>
                    <input type="text" name="slider_title" id="slider_title" class="form-control ">
                  </div>
                </div>
                <div class="col-sm-12">
                  <div class="form-group">
                    <label class="col-form-label" for="inputError">Slider Desc</label>
                    <input type="text" name="slider_desc" id="slider_desc" class="form-control ">
                  </div>
                </div>
              </div>
