    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          ?>
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>/patientinfo/edit<?php echo $patient_id_value; ?><?php echo $project_id_value; ?>" class="nav-link">
            ...
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>/clinicalinfo/edit<?php echo $patient_id_value; ?><?php echo $project_id_value; ?>" class="nav-link">
            ...
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>/slidelevelinfo/edit<?php echo $patient_id_value; ?><?php echo $project_id_value; ?>" class="nav-link">
                <i class="nav-icon fas fa-briefcase-medical"></i>
                <p>
            ...
            <li class="nav-item">
              <a href="<?php echo base_url(); ?>/gen_qrcode<?php echo $patient_id_value; ?><?php echo $project_id_value; ?>" class="nav-link">
          ...
          <?php }else{ ?>
            ...
            ?>
              <li class="nav-item">
                <a href="<?php echo base_url('/patientdetails'.$project_id_value); ?>" class="nav-link">
                  <i class="nav-icon fas fa-users"></i>
                  <p>
                    Patient Details
                  </p>
