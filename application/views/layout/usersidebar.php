<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <!-- Sidebar -->
    <div class="sidebar">
      <!-- <h5 class="text-white text-center mt-2"><?= !empty($project_name) ? $project_name : '' ?></h5><hr> -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>/project" class="nav-link">
              ...
              <p>
                <?= !empty($project_name) ? $project_name : 'Projects' ?>
                <!-- <span class="right badge badge-danger">New</span> -->
              </p>
            </a>
          </li>
          <!-- <li class="nav-item">
            <a href="<?php echo base_url(); ?>/patientinfo" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url(); ?>/clinicalinfo" class="nav-link">
